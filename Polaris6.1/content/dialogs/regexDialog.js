// content/dialogs/regexDialog.js
...
function showCustomRegexModules(resultDiv) {
  ...
  title.textContent = "工具模块菜单";
  title.style.cssText = "font-size: 16px; font-weight: 600; color: #2c3e50; margin-bottom: 10px;";
  resultDiv.appendChild(title);

  const extractCookieButton = document.createElement('button');
  extractCookieButton.textContent = "提取Cookie";
  extractCookieButton.className = 'action-button';
  extractCookieButton.style.marginBottom = "10px";
  extractCookieButton.addEventListener('click', showCookieDialog);
  resultDiv.appendChild(extractCookieButton);

  const extractMapButton = document.createElement('button');
  extractMapButton.textContent = "提取Map文件";
  extractMapButton.className = 'action-button';
  extractMapButton.style.marginBottom = "15px";
  extractMapButton.addEventListener('click', showMapDialog);
  resultDiv.appendChild(extractMapButton);
